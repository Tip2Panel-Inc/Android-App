    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCameraFragment == null) {
            ...
            ActivityUtils.addFragmentToActivity(
                    getSupportFragmentManager(), mCameraFragment, R.id.fragment_container);
        }
                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem item) {
                        ...
                        if (id ==  R.id.nav_dashboard) {
                            ...
                            intent =
                                    new Intent(CameraActivity.this, DevicesActivity.class);
                        } else if (id == R.id.nav_devdisco) {
                            intent =
                                    new Intent(CameraActivity.this, DiscoveryActivity.class);
                        } else if (id == R.id.nav_gateway) {
                            intent =
                                    new Intent(CameraActivity.this, GatewayActivity.class);
